...
w=A.b([],w)
if(x)w.push(D.z5)
w.push(A.a_j(new A.cy(D.Dd,new B.EK(x,null),null)))
v.push(A.hy(w,C.al,C.C,C.G))
return E.a9g(A.cj(v,C.I,C.C,C.G),"about-content")}}
B.EK.prototype={
G(d){var x=null,w=A.cs("Who am I?",x,x,A.cO(x,x,C.dS,x,x,x,x,x,x,x,x,32,x,x,C.aM,x,x,!0,x,x,x,x,x,x,x,x),x)
...
D.K9=new F.yP("assets/images/about/me.webp",200,null)})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_8",e:"endPart",h:b})})($__dart_deferred_initializers__,"76hJjByrNCuTCE7sPzLocQkpznc=");