...
this.b=e},
AD:function AD(){},
atS(){return new A.uo(null)},
anf(d,e){var x=null,w=B.b([B.cf(d,B.bA(x,x,C.ho,x,x,x,x,x,x,x,x,18,x,x,C.d7,x,x,!0,x,x,x,x,x,x,x,x)),B.cd(x,16,x)],y.e)
C.b.K(w,new B.al(e,new A.acO(),B.a_(e).h("al<1,h>")))
return B.c_(w,C.T,C.y,C.D)},
uo:function uo(d){this.a=d},
KP:function KP(d){this.d=d
this.c=this.a=null},
...
KK:function KK(){this.d=!1
this.c=this.a=null},
a9d:function a9d(d){this.a=d},
a9c:function a9c(d){this.a=d}},D,E,F
B=c[0]
C=c[2]
...
x=B.e5(C.ht,x,u)
x.Y(0,new A.acg(v))
v.d=new B.ar(x,new A.x2(0,w.length),y.a.h("ar<ad.T>"))
if(v.a.w)v.e.cB(0)
x=v.e
x.bp()
x=x.bV$
x.b=!0
x.a.push(new A.ach(v))},
m(){var x=this.e
x===$&&B.a()
x.m()
this.Sf()},
I(d){var x=null,w=B.be(d,x,y.h).w,v=this.d
return B.d2(x,v==null?x:B.lU(v,new A.ace(this,!(w.a.a>=900)),x),C.t,x,x,x,x,x,x,x,x,x,x)}}
A.AD.prototype={
bI(){this.de()
this.cG()
this.ew()},
...
x.an()}}
A.uo.prototype={
a7(){return new A.KP(B.wp())}}
A.KP.prototype={
m(){this.d.m()
this.an()},
I(d){return new E.kM(B.c_(B.b([new A.um(null),new A.uF(null)],y.e),C.T,C.y,C.D),null)}}
A.uF.prototype={
a7(){return new A.L5()}}
A.L5.prototype={
...
Tj(d){var x,w=this,v=null,u=$.ahl,t=w.d,s=y.e
t=B.b([A.agu("Hey! I'm "+u,!t,new A.a9E(w),B.bA(v,v,C.A,v,v,v,v,v,v,v,v,d?22:14,v,v,C.aB,v,v,!0,v,v,v,v,v,v,v,v))],s)
u=B.cd(v,16,v)
x=w.f
C.b.K(t,B.b([u,A.agu("Experienced Data Science Leader",!x,new A.a9F(w),B.bA(v,v,C.ho,v,v,v,v,v,v,v,v,d?24:20,v,v,C.I,v,v,!0,v,v,v,v,v,v,v,v))],s))
return B.c_(t,C.T,C.y,C.D)},
Tc(d){var x=null
return B.c_(B.b([B.cd(x,24,x),A.agu("I deliver transformational AI solutions with measurable business impact, for example:\n\n\u2022 Built large-scale fraud detection systems saving millions in prevented losses\n\u2022 Developed real-time decision engine processing 100k+ daily leads at <300ms\n\u2022 Achieved 15% ROI improvement through ML-driven marketing optimization\n\nAs the author of bestselling books on GenAI and ML implementation, I combine deep technical expertise with real-world business understanding.\n\n",!this.r,new A.a9B(this),B.bA(x,x,C.hj,x,x,x,x,x,x,x,x,16,x,x,x,x,1.5,!0,x,1.2,x,x,x,x,x,x))],y.e),C.T,C.y,C.D)}}
A.fk.prototype={}
A.yb.prototype={
a7(){return new A.K7()}}
A.K7.prototype={
...
A.KK.prototype={
ak(){this.aP()
B.mr(B.cy(0,250),new A.a9d(this),y.p)},
I(d){var x,w,v,u=B.be(d,null,y.h).w.a.a
if(u>1200)x=300
else x=u>768?250:200
w=this.d?1:0
v=B.cy(0,250)
this.a.toString
return F.ait(B.ut("assets/images/logo/logo.webp",C.j,null,x,x),v,w)}}
var z=a.updateTypes(["h(fk)"])
A.acg.prototype={
$0(){this.a.ad(new A.acf())},
$S:0}
A.acf.prototype={
$0(){},
$S:0}
...
v=w.b
w=w.a
t=C.d.aa(t,0,v.U(0,w.gl(w)))}return B.cf(t,B.bA(x,x,C.b5,x,x,x,x,x,x,x,x,!this.b?16:14,x,x,x,x,1.6,!0,x,x,x,x,x,x,x,x))},
$S:414}
A.a9E.prototype={
$0(){var x=this.a
if(x.c!=null)x.ad(new A.a9D(x))},
$S:0}
A.a9D.prototype={
$0(){this.a.d=!0},
$S:0}
...
w(A.P_,A.AD)
v(B.m7,[A.acg,A.acf,A.ach,A.a9E,A.a9D,A.a9F,A.a9C,A.a9B,A.a9A,A.a8n,A.a8m,A.a8o,A.a9d,A.a9c])
w(A.ace,B.m8)
w(A.fk,B.A)
