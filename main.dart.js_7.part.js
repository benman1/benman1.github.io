...
return A.cu(A.b([A.eC(A.b([A.dU(w,H.a91(u,v,w),B.u,w,w,w,w,w,w,w,w,w,250),A.m_(w,w,32),A.qt(x.HX(d))],t),B.Z,B.y,B.A),x.HZ(d)],t),B.Z,B.y,B.A)}else{t=A.b4(d,w,t).w.a.a<600?150:200
return A.cu(A.b([A.fn(A.dU(w,H.a91(u,v,w),B.u,w,w,w,w,w,new A.at(0,0,0,12),w,w,w,t),w,w),x.HX(d),x.HZ(d)],y.e),B.Z,B.y,B.A)}},
...
x=y.h
B.b.O(i,this.Ze(A.b(["Architected fraud detection systems preventing millions in annual losses","Built real-time ML platforms processing 100k+ transactions daily at <300ms latency","Led AI transformation projects improving marketing ROI by 15%","Published bestselling technical books with 100k+ in sales","Co-founded and scaled Data Science Speakers London community"],x)))
i.push(B.aO)
i.push(new A.b8(new C.bK(m,B.bu),A.bf(m,v,v,$.v4(),v),v))
i.push(F.bf)
i.push(this.Zh(A.b(["Enterprise AI Strategy & Digital Transformation","MLOps & Scalable System Architecture","GenAI Solutions & LLM Implementation","Technical Leadership & Team Building","Real-time ML Systems & Performance Optimization"],x)))
i.push(B.aO)
i.push(new A.b8(new C.bK(l,B.bu),A.bf(l,v,v,$.v4(),v),v))
i.push(F.bf)
i.push(new A.b8(new C.bK(k,B.am),A.bf(k,v,v,E.aA,v),v))
i.push(B.aO)
i.push(new A.b8(new C.bK(j,B.am),A.bf(j,v,v,E.aA,v),v))
return A.cu(i,B.Z,B.y,B.A)},
Ze(d){var x=A.W(d).h("X<1,b8>")
return A.a_(new A.X(d,new D.TZ(),x),!0,x.h("au.E"))},
Zh(d){var x=A.W(d).h("X<1,b8>")
return A.cu(A.a_(new A.X(d,new D.U_(),x),!0,x.h("au.E")),B.Z,B.y,B.A)}}
var z=a.updateTypes([])
D.TZ.prototype={
$1(d){var x=null
return new A.b8(new C.bK(d,B.am),new A.c2(G.f4,A.eC(A.b([G.jR,A.qt(A.bf(d,x,x,E.aA,x))],y.e),B.Z,B.y,B.A),x),x)},
$S:191}
D.U_.prototype={
$1(d){var x=null
return new A.b8(new C.bK(d,B.am),new A.c2(G.f4,A.eC(A.b([G.jR,A.qt(A.bf(d,x,x,E.aA,x))],y.e),B.Z,B.y,B.A),x),x)},
...
x(D.mR,C.mW)
w(A.fo,[D.TZ,D.U_])})()
A.uJ(b.typeUniverse,JSON.parse('{"mR":{"aa":[],"f":[]}}'))
var y={h:A.a5("u<m>"),e:A.a5("u<f>"),k:A.a5("eB")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_7",e:"endPart",h:b})})($__dart_deferred_initializers__,"pDT+lWLvo2SSkTXNgK7ZShxMaRs=");