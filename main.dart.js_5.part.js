...
w=y.e
v=A.a([],w)
if(!o)v.push(new C.rB(r))
u=A.a([],w)
if(o)u.push(A.d2(r,new C.rB(r),B.t,r,r,r,r,r,r,r,r,r,200))
p=p.a.a<600?0:48
t=A.cq("Who am I?",A.bD(r,r,B.cL,r,r,r,r,r,r,r,r,32,r,r,B.aw,r,r,!0,r,r,r,r,r,r,r,r))
s=A.ce(r,24,r)
u.push(A.Dk(A.d2(r,A.c_(A.a([t,s,A.cq("With over 15 years in data science, I've helped organizations deliver transformational AI projects - from fraud detection systems saving large amounts of fraud losses to real-time lending platforms processing 100k+ daily decisions.\n\nI've worked with industry leaders including Hastings Direct, Loveholidays, Oleeo, and Smarkets. My expertise spans practical AI implementation, GenAI solutions, and ML-driven optimization. I'm also the author of several bestselling technical books, including guides on GenAI and ML implementation.\n\nWhen not consulting or writing, I spend time with my son, who's currently deciding between becoming a professional football player or a machine learning engineer. I also practice Choi Kwang Do, constantly working on improvement.\n\nInterested in working together? Contact me to discuss how I can help your organization succeed with AI.",A.bD(r,r,B.aZ,r,r,r,r,r,r,r,r,o?16:14,r,r,r,r,1.6,!0,r,r,r,r,r,r,r,r))],w),B.S,B.x,B.B),B.t,r,r,r,r,r,r,new A.aK(p,24,p,24),r,r,r)))
v.push(A.fI(u,B.S,B.x,B.B))
return new D.kG(A.d2(r,A.c_(v,B.K,B.x,B.B),B.t,r,r,new A.cn(B.i,r,r,q,x,r,B.ab),r,r,r,r,r,r,r),r)}}
C.rB.prototype={
H(d){var x,w=null,v=A.bi(d,w,y.h).w.a.a
if(v>1200)x=200
else x=v>768?200:150
return A.lY(A.uD("assets/images/about/me.png",w,B.fe,x,x),w,w)}}
